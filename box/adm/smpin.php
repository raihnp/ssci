...
$result = mysqli_query($conn,"SELECT * FROM smp  ORDER BY id DESC LIMIT 1");
...
if(isset($_POST["submit"])){
  ...
  $query = "UPDATE smp SET tgl='$tgl',tawar1='$tawar1', kategori1='$kategori1',tingkat1='$tingkat1', tingkata1='$tingkata1',tingkatb1='$tingkatb1', tingkatc1='$tingkatc1',harga1='$harga1',tawar2='$tawar2', kategori2='$kategori2',tingkat2='$tingkat2', tingkata2='$tingkata2',tingkatb2='$tingkatb2', tingkatc2='$tingkatc2',harga2='$harga2',tawar3='$tawar3', kategori3='$kategori3',tingkat3='$tingkat3', tingkata3='$tingkata3',tingkatb3='$tingkatb3', tingkatc3='$tingkatc3',harga3='$harga3',tawar4='$tawar4', kategori4='$kategori4',tingkat4='$tingkat4', tingkata4='$tingkata4',tingkatb4='$tingkatb4', tingkatc4='$tingkatc4',harga4='$harga4',tawar5='$tawar5', kategori5='$kategori5',tingkat5='$tingkat5', tingkata5='$tingkata5',tingkatb5='$tingkatb5', tingkatc5='$tingkatc5',harga5='$harga5',tawar6='$tawar6', kategori6='$kategori6',tingkat6='$tingkat6', tingkata6='$tingkata6',tingkatb6='$tingkatb6', tingkatc6='$tingkatc6',harga6='$harga6'";
   mysqli_query($conn, $query);
    ...
    document.location.href = 'smpin.php';
    </script>";} 
  else {
...
<!-- xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx -->
 <section  class="d-md-none">
      ...
      <section class="tab d-none d-md-block">
       ...
       <br>
      <center><h2>Ganti Penawaran SMP</h2></center>
      <br>
...
<br>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="fg1">
              <div class="form-group">
                <label for="pdf6" class="control-label">Tahun penawaran 6</label>
                <input type="text" name="tawar6" value="<?=$row["tawar6"];?>" class="form-control" id="pdf6" autocomplete="off">
              </div>
              <div class="form-group">
                <label for="pdf66" class="control-label">Kategori6</label>
                <input type="text" name="kategori6" value="<?=$row["kategori6"];?>" class="form-control" id="pdf66" autocomplete="off">
              </div>
              <div class="form-group">
                <label for="pdf6" class="control-label">Spsifikasi_a6</label>
                <input type="text" name="tingkat6" value="<?=$row["tingkat6"];?>" class="form-control" id="pdf6" autocomplete="off">
              </div>
              <div class="form-group">
                <label for="pdf66" class="control-label">Spsifikasi_b6</label>
                <input type="text" name="tingkata6" value="<?=$row["tingkata6"];?>" class="form-control" id="pdf66" autocomplete="off">
              </div>
              <div class="form-group">
                <label for="pdf6" class="control-label">Spsifikasi_c6</label>
                <input type="text" name="tingkatb6" value="<?=$row["tingkatb6"];?>" class="form-control" id="pdf6" autocomplete="off">
              </div>
              <div class="form-group">
                <label for="pdf66" class="control-label">Spsifikasi_d6</label>
                <input type="text" name="tingkatc6" value="<?=$row["tingkatc6"];?>" class="form-control" id="pdf66" autocomplete="off">
              </div>
              <div class="form-group">
                <label for="pdf6" class="control-label">harga6</label>
                <input type="text" name="harga6" value="<?=$row["harga6"];?>" class="form-control" id="pdf6" autocomplete="off">
              </div>
            </div>  
          </div>
