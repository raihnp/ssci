    ...
    <div class="row justify-content-center ">
      <div class="col-md-4">
        <div class="container">
          ...
          <a href="form.php?no=1&pen=privat" target="_blank"><button class="cta"><p><b>Ambil Kelas <?=$row["kategori1"];?></b></p></button></a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="container">
          ...
          <a href="form.php?no=2&pen=privat" target="_blank"><button class="cta"><p><b>Ambil Kelas <?=$row["kategori2"];?></b></p></button></a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="container">
          ...
          <a href="form.php?no=3&pen=privat" target="_blank"><button class="cta"><p><b>Ambil Kelas <?=$row["kategori3"];?></b></p></button></a>
        </div>
      </div>
    </div>
