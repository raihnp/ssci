...
<div class="row justify-content-center isi mx-auto">
      <div class="col-md-4">
        <div class="container">
          ...
          <a href="form.php?no=1&pen=sd" target="_blank"><button class="cta"><p><b>Ambil Kelas <?=$row["kategori1"];?></b></p></button></a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="container">
          ...
          <a href="form.php?no=2&pen=sd" target="_blank"><button class="cta"><p><b>Ambil Kelas <?=$row["kategori2"];?></b></p></button></a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="container">
          ...
          <a href="form.php?no=3&pen=sd" target="_blank"><button class="cta"><p><b>Ambil Kelas <?=$row["kategori3"];?></b></p></button></a>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="container">
          ...
          <a href="form.php?no=4&pen=sd" target="_blank"><button class="cta"><p><b>Ambil Kelas <?=$row["kategori4"];?></b></p></button></a>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="container">
          ...
          <a href="form.php?no=5&pen=sd" target="_blank"><button class="cta"><p><b>Ambil Kelas <?=$row["kategori5"];?></b></p></button></a>
        </div>
      </div>
    </div>
    ...
    <div class="move-up">
        ...
        <a href="https://api.whatsapp.com/send?phone=628123456789&text=Hallo%20Agan%20Baik" target="_blank"> <img src="../../img/w.png" width="40px"></a>
    </div>
