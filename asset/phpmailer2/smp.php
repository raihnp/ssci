...
<div class="row justify-content-center isi mx-auto">
      <div class="col-md-4">
        <div class="container">
          ...
          <a href="form.php?no=1&pen=smp" target="_blank"><button class="cta"><p><b>Ambil Kelas <?=$row["kategori1"];?></b></p></button></a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="container">
          ...
          <a href="form.php?no=2&pen=smp" target="_blank"><button class="cta"><p><b>Ambil Kelas <?=$row["kategori2"];?></b></p></button></a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="container">
          ...
          <a href="form.php?no=3&pen=smp" target="_blank"><button class="cta"><p><b>Ambil Kelas <?=$row["kategori3"];?></b></p></button></a>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="container">
          ...
          <a href="form.php?no=4&pen=smp" target="_blank"><button class="cta"><p><b>Ambil Kelas <?=$row["kategori4"];?></b></p></button></a>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="container">
          ...
          <a href="form.php?no=5&pen=smp" target="_blank"><button class="cta"><p><b>Ambil Kelas <?=$row["kategori5"];?></b></p></button></a>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="container">
          ...
          <a href="form.php?no=6&pen=smp" target="_blank"><button class="cta"><p><b>Ambil Kelas <?=$row["kategori6"];?></b></p></button></a>
        </div>
      </div>
    </div>
